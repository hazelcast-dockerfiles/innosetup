...
RUN apt-get update \
    ...
    && for xbits in 32 64; do \
         curl -s -o /tmp/jre${xbits}.zip -L "https://api.adoptopenjdk.net/v2/binary/releases/openjdk8?openjdk_impl=hotspot&os=windows&arch=x${xbits}&release=latest&type=jre"; \
